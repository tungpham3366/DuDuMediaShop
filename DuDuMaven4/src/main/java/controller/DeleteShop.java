 ...
 * @author ADMIN
 */
@WebServlet(name="DeleteShop", urlPatterns={"/DeleteShop"})
public class DeleteShop extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int shopID = Integer.parseInt(shopID_raw);
        int userID = Integer.parseInt(userID_raw);
        ShopDAO sd = new ShopDAO();
        ProductDAO pd = new ProductDAO();
        pd.DeleteProductByShopID(shopID);
        sd.DeleteShopByID(shopID);
        List<Shop> rlist = sd.getShopByAccountID(userID);
