...
public class UProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //Block
        List<User> listofblock = bd.getBlockListFromUserID(userID);
        if(listofblock.isEmpty())
        {
            request.setAttribute("noblock","You Haven't Block Any User");
        }

        request.setAttribute("listofblock", listofblock);
