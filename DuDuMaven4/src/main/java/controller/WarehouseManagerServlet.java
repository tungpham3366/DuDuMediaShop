 ...
 * @author PC
 */
@WebServlet(name="WarehouseManagerServlet", urlPatterns={"/WarehouseManager"})
public class WarehouseManagerServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            List<Warehouse> list = wd.getListOfWareHouseByProductId(id);
            request.setAttribute("list", list);
        } catch (Exception e) {
        }
                    request.setAttribute("productID",productID);
        request.getRequestDispatcher("WarehouseManager.jsp").forward(request, response);
    } 
